...
import { forgotPasswordSchema, type ForgotPasswordRequest } from '@mayday/shared';
      ...
      <div className="max-w-md mx-auto px-4 py-16">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-4">
          <p className="text-gray-700">
            If <span className="font-medium">{submittedEmail}</span> matches a Mayday
            account, we've sent a password reset link. Click it to choose a new password.
          </p>
          <p className="text-sm text-gray-500">
            The link expires in 1 hour. Don't see it? Check your spam folder, or try again
            in a few minutes.
          </p>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        >
          ...
          <button
            ...
            className="w-full bg-mayday-500 text-white py-2 rounded-lg font-medium hover:bg-mayday-600 disabled:opacity-50"
          >
