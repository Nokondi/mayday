      ...
      <section className="bg-gradient-to-br from-mayday-500 to-mayday-700 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-mayday-100 mb-8">
            Request help or offer resources in your neighborhood. Together, we're stronger.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Need groceries, a ride, or someone to talk to? Share your need with the community.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Have skills, time, or supplies to share? Let your neighbors know you're available.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Find and connect with people near you through our map and matching system.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/posts" className="text-mayday-600 hover:text-mayday-700 font-medium flex items-center gap-1">
