...
organizationRoutes.get('/', async (req: AuthRequest, res, next) => {
  try {
...
organizationRoutes.get('/mine', async (req: AuthRequest, res, next) => {
  try {
...
organizationRoutes.get('/me/invites', async (req: AuthRequest, res, next) => {
  try {
...
organizationRoutes.post('/me/invites/:inviteId/accept', async (req: AuthRequest, res, next) => {
  try {
...
organizationRoutes.post('/me/invites/:inviteId/decline', async (req: AuthRequest, res, next) => {
  try {
    const invite = await prisma.organizationInvite.findUnique({
      where: { id: req.params.inviteId as string },
    });
...
organizationRoutes.post('/', validate(createOrganizationSchema), async (req: AuthRequest, res, next) => {
  try {
...
organizationRoutes.patch('/:id', validate(updateOrganizationSchema), async (req: AuthRequest, res, next) => {
  try {
    const orgId = req.params.id as string;
...
organizationRoutes.delete('/:id', async (req: AuthRequest, res, next) => {
  try {
    const orgId = req.params.id as string;
    const membership = await prisma.organizationMember.findUnique({
      where: { organizationId_userId: { organizationId: orgId, userId: req.user!.id } },
...
organizationRoutes.get('/:id/members', async (req: AuthRequest, res, next) => {
  try {
...
organizationRoutes.patch('/:id/members/:userId', validate(updateMemberRoleSchema), async (req: AuthRequest, res, next) => {
  try {
    const orgId = req.params.id as string;
...
organizationRoutes.delete('/:id/members/:userId', async (req: AuthRequest, res, next) => {
  try {
    const orgId = req.params.id as string;
    const targetUserId = req.params.userId as string;
...
organizationRoutes.get('/:id/invites', async (req: AuthRequest, res, next) => {
  try {
    const orgId = req.params.id as string;
    const membership = await prisma.organizationMember.findUnique({
      where: { organizationId_userId: { organizationId: orgId, userId: req.user!.id } },
...
organizationRoutes.post('/:id/invites', validate(inviteToOrganizationSchema), async (req: AuthRequest, res, next) => {
  try {
    const orgId = req.params.id as string;
    const membership = await prisma.organizationMember.findUnique({
      where: { organizationId_userId: { organizationId: orgId, userId: req.user!.id } },
...
organizationRoutes.delete('/:id/invites/:inviteId', async (req: AuthRequest, res, next) => {
  try {
    const orgId = req.params.id as string;
